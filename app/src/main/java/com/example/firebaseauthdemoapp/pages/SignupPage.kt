...
fun SignupPage(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.logodrogariabranca),
        ...
        OutlinedTextField(
            ...
            label = { Text("Email", color = Color(0xFFF2F2F2)) },
        ...
        OutlinedTextField(
            ...
            label = { Text("Senha", color = Color(0xFFF2F2F2)) },
            textStyle = TextStyle(color = Color(0xFFF2F2F2)),
            modifier = Modifier.fillMaxWidth()
        )
